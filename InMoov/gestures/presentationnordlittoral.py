...
def presentationnordlittoral():
  ...
  i01.moveTorso(90,90,90)
  i01.mouth.speakBlocking("je m appelle néo")
  i01.moveHead(68,90)
  i01.moveArm("left",5,99,30,16)
  ...
  i01.moveTorso(90,90,90)
  sleep(1)
  i01.mouth.speakBlocking("j ai été crée par gael langevin")
  ...
  i01.moveHead(79,88)                           #
  i01.moveArm("left",90,120,0,20)              #bras et tete qui regarde vers l'imprimante 3d a gauche
  i01.moveArm("right",5,30,20,10)               #
  i01.moveHand("left",0,0,0,0,0,0)
  i01.moveHand("right",0,0,0,0,0,0)
  i01.moveTorso(90,90,90)
  i01.mouth.speakBlocking("sont fabriquer sur une petite imprimante familiale comme celle ci")
  sleep(1)
  i01.moveHead(40,84)
  ...
  sleep(1)
  i01.mouth.speakBlocking("et voici l équipe du projet néo")
  i01.moveHead(80, 98)                  #mouvement a regler tourner la tete et le bras droit vers l'equipe
  i01.moveArm("left", 5, 30, 20, 10)    #
  i01.moveArm("right", 90, 120, 0, 20)  #
  i01.moveHand("left", 0, 0, 0, 0, 0, 0)
  i01.moveHand("right", 0, 0, 0, 0, 0, 0)
  i01.moveTorso(90, 90, 90)
  sleep(1)
